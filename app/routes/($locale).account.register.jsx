...
function Ragister() {
  return (
    <div class="cust-sign-page bg-grey clearfix">
      ...
      <div class="container">
        <h2 class="page-title text-up text-center">Contact Us</h2>
        <div class="cust-contact-wrap dfx flxcntr">
          <div class="cust-cntct-info dfx dfxcl">
            <ul>
              <li>
                <svg
            ...
            <div class="social-icons dfx flxwrp">
          ...
          <div class="cust-sign-form flx-cover">
            <form>
